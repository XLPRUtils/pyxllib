...
import pyxllib.file.packlib.zipfile as xlzipfile
...
zipfile.ZipFile._RealGetContents = xlzipfile.ZipFile._RealGetContents
zipfile.ZipFile.open = xlzipfile.ZipFile.open
